...
<section class="trad">
<p>L'hexagone n'est pas un hexagone car le nombre six est important, mais parce qu'il permet aux personnes qui le dessinent d'avoir de la place pour insérer les ports et les adaptateurs selon leurs besoins, sans être contraint par un schéma monodimensionnel en couche. Le terme “architecture hexagonale” trouve son origine dans cet effet visuel.</p></section>
